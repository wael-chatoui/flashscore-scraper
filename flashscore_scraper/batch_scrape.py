...
async def scrape_day(days_offset: int, sport: str = 'volleyball') -> list[dict]:
    ...
    file_prefix = 'hockey_matches' if sport == 'hockey' else ('football_matches' if sport == 'football' else 'matches')
...
def load_all_jsons(sport: str = 'volleyball') -> list[dict]:
    ...
    all_data = []
    pattern = 'hockey_matches_*.json' if sport == 'hockey' else ('football_matches_*.json' if sport == 'football' else 'matches_*.json')
